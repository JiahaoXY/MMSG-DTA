...
- First, run graph_prepare.py using
  ...
  ```     
    ...
    If you prefer not to generate the contact map for the graph yourself, you can find it available for download at [https://zenodo.org/records/14444598](https://zenodo.org/records/14441791).
